...
- L1-REIN-03: the approved client content says the learner hears one of five
  ...
  legacy parser persisted only the correct option, so we restore two distractors
  from the same five approved words used by that activity.
"""
...
if __name__ == "__main__":
    print(f"Created {run_seed()} approved choice-presentation distractors")
