...
- `docs/maintenance/HIMMA_A10_W4_AUTOMATION_CHECKPOINT_2026-09-14_BADGE_003_GREEN_AR.md`
...
- `AUD-BADGE-005` CLOSED GREEN by existing executable canonical completion evidence on the #851 baseline.
- `AUD-BADGE-007` CLOSED GREEN — `970416d707639a3cab2f0dfa930b9f78990afe20`, #853 / `34733663693`.
- `AUD-BADGE-003` CLOSED GREEN — official `BDG-01..BDG-06` SVG assets integrated and canonical `asset_path` mapping verified at exact code SHA `8736372f855e55646ce50712615b6274af94a9a8`, Quality Gate #854 / Run ID `34803602294`, SUCCESS across backend/security/frontend/integration including Playwright E2E.
...
1. `AUD-BADGE-001` — render canonical badge/icon visuals on Student Home while preserving unavailable vs empty vs populated reward semantics.
2. `AUD-BADGE-002` — render the same canonical badge visual system in Admin.
3. `AUD-MEDIA-002` — implement and test the approved role-aware lexical/context media contract, including the known `L2-CORE-09` cases.
