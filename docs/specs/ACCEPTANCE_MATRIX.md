...
| AC-02 | إنشاء الطلاب برموز مستقلة وآمنة ضمن السعة الافتراضية 50 طالبًا عبر HIMMA_MAX_STUDENTS، مع احتساب غير النشطين ضمن الحد | 1 | integration + authorization + capacity tests |
...
| AC-07 | التسجيل المعلق لا يتحول إلى خطأ ولا يمنع بقية الأسئلة غير المجابة؛ الإنهاء النهائي ينتظر المراجعة، وإعادة التسجيل مهمة صريحة تحفظ التاريخ | 2/4 | pending-audio navigation + review/rerecord boundary tests + E2E |
