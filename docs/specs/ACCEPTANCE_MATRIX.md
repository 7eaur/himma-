...
| AC-06 | التسجيل يُحفظ ويرتبط بالمحاولة ويحلل عند الصلاحية | 4 | real adapter integration + E2E |
| AC-07 | نتيجة موثوقة أو «تحتاج مراجعة» دون تضليل | 4 | confidence boundary tests + review flow |
...
| AC-13 | الصوت الفاشل/المنخفض لا يؤثر في الدرجة أو التكيف | 4 | domain + queue failure tests |
